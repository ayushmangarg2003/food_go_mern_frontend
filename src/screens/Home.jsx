...
const Home = () => {
  ...
  const loadData = async () => {
    let response = await fetch("https://foodgomernbackend.onrender.com/api/foodData", {
      method: "POST",
      headers: {
  ...
  return (
    <div>
      <div>
        <div id="carouselExampleFade" style={{ "objectFit": "center !important" }} className="carousel slide carousel-fade" data-bs-ride="carousel" >
